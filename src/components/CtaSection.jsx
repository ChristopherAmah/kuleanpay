    ...
    <div className="flex items-center justify-center p-4 sm:p-6 lg:p-8 font-sans">
      ...
      >
        <div className="flex flex-col items-center">
          ...
          <button className="mt-10 px-8 py-3 bg-white text-gray-900 font-semibold rounded-lg shadow-md hover:bg-gray-100 transition-colors duration-300 focus:outline-none focus:ring-2 focus:ring-white focus:ring-opacity-50">
            Get Started
          </button>
        </div>
      </div>
