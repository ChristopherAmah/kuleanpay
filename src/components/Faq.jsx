...
const FaqItem = ({ question, answer, isOpen, onToggle }) => {
  return (
    <div className="border-b border-gray-200 py-6">
      ...
      >
        <h3 className="text-lg font-medium text-[#1B2632]">{question}</h3>
...
const App = () => {
  ...
  const faqData = {
    General: [
      ...
      {
        question: 'Can we regist via online?',
  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4 sm:px-6 lg:px-8 lg:py-16 font-sans">
      <div className="w-full max-w-7xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-24">
          
          {/* Left Section */}
          <div className="flex flex-col justify-center">
            <h1 className="text-5xl md:text-6xl font-bold text-[#454545]">
              Frequently Asked <br />
              <span className="text-[#3b49df]">Questions</span>
            </h1>
            <p className="mt-6 text-[#19203199] text-[18px] font-medium">
              have some questions before you get started? check out our FAQs or lets talk :)
            </p>
            <div className="mt-10 grid grid-cols-1 sm:grid-cols-2 gap-6">
              <div className="border-2 border-[#03045E] rounded-2xl p-6 flex flex-col items-center text-center cursor-pointer hover:bg-blue-50 transition-colors">
                <div className="w-16 h-16  flex items-center justify-center">
                  <Headset className="text-[#03045E]" size={32} />
                </div>
                <p className="mt-4 font-medium text-[16px] text-[#19203199]">Call with Customers Service</p>
              </div>
              <div className="bg-[#D6DAE43D] rounded-[16px] p-6 flex flex-col items-center text-center cursor-pointer hover:bg-gray-50 transition-colors">
                 <div className="w-16 h-16 flex items-center justify-center">
                  <MessageSquare className="text-[#292D32]" size={32} />
                </div>
                <p className="mt-4 font-medium text-[16px] text-[#19203199]">Chat with Kuleanpays Bot system</p>
              </div>
            </div>
          </div>
            ...
            <div className="flex flex-wrap gap-4 mb-8">
              {tabs.map(tab => (
                  <button
                    ...
                    className={`px-6 py-2 rounded-lg text-sm font-medium transition-colors focus:outline-none ${
                      activeTab === tab
